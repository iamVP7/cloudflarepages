...
import dummyLogo from '../public/confbanner.png'
  ...
  return (
    ...
    <div className={styles.container}>
      {<Head>
        ...
        <Image  unoptimized={true} src="./confbanner.png" alt="Vercel Logo" width={800} height={400} layout="fixed"/>
      </Head>}
      ...
      <footer >
        <section  className={styles.footersection}>
          <a href="https://twitter.com" target="_blank"rel="noopener noreferrer">
            <Image  unoptimized={true} src="./twitter.png" alt="Twitter Logo" width={128} height={128}/>
          </a>
          <a href="https://facebook.com" target="_blank"rel="noopener noreferrer">
          <Image  unoptimized={true} src="./twitter.png" alt="Facebook Logo" width={128} height={128}/>
          </a>
          <a href="https://linkedin.com" target="_blank"rel="noopener noreferrer">
          <Image unoptimized={true} src="./twitter.png" alt="Linkedin Logo" width={128} height={128}/>
          </a>
          </section>
