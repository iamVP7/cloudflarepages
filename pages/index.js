  ...
  return (
    ...
    <div className={styles.container}>
      <Head>
        ...
        <Image loader={myLoader} src="dummy_logo.png" alt="Vercel Logo" width={800} height={400} />
      </Head>
      ...
      <footer >
        <section  className={styles.footersection}>
          <a href="https://twitter.com" target="_blank"rel="noopener noreferrer">
            <Image loader={myLoader} src="twitter.png" alt="Twitter Logo" width={64} height={64} />
          </a>
          <a href="https://facebook.com" target="_blank"rel="noopener noreferrer">
          <Image loader={myLoader} src="facebook.png" alt="Facebook Logo" width={64} height={64} />
          </a>
          <a href="https://linkedin.com" target="_blank"rel="noopener noreferrer">
          <Image loader={myLoader} src="linkedin.png" alt="Facebook Logo" width={64} height={64} />
          </a>
          </section>
