  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <img src="https://github.com/viswa.png" alt="Git hub pic" width={128} height={128}/>

        <p>Celberate the conference without fail.</p>
        <p>October 31, 2021 9am-1pm PT / Online.</p>
        
        <a className={styles.twitter_share_button}href="https://twitter.com/intent/tweet?text=Join%20the%20Conference  https://cloudflarepages-9jp.pages.dev/conf/f3ace342467d3da0f63aa283a0c020794940df008887e058f19bd15ef978641e">Tweet Your Ticket</a>
       </main>
       <footer >
